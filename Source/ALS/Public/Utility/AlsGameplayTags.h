...
namespace AlsTags
{
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Als)
}

namespace AlsViewModeTags
{
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(ViewMode)
...
{
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(LocomotionMode)
...
{
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(RotationMode)
...
{
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(AimingMode)
...
{
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Stance)
...
{
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Gait)
...
{
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(OverlayMode)
...
{
	ALS_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(LocomotionAction)
