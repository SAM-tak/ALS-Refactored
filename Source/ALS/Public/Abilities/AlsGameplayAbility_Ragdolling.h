...
public:
	...
	UPROPERTY(
		EditAnywhere, BlueprintReadWrite, Category = "ALS|Ability", Meta = (ClampMin = 0, EditCondition = "bAllowFreeze", ForceUnits = "s"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "ALS|Ability",
		Meta = (ClampMin = 0, EditCondition = "bAllowFreeze", ForceUnits = "deg"))
