...
public:
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = AlsAbility, Meta = (ClampMin = 0, ClampMax = 180, ForceUnits = "deg"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = AlsAbility, Meta = (ClampMin = 0, ClampMax = 90, ForceUnits = "deg"))
	float SlopeAngleThreshold{35.0f};

	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = AlsAbility, AdvancedDisplay, Meta = (ClampMin = 0, ClampMax = 1))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = AlsAbility, Meta = (ForceUnits = "cm/s"))
	float TargetPrimitiveSpeedThreshold{10.0f};

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = AlsAbility, Meta = (ForceUnits = "cm"))
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = AlsAbility, AdvancedDisplay)
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = AlsAbility, Meta = (ClampMin = 0, ForceUnits = "s"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = AlsAbility, Meta = (EditCondition = "bStartRagdollingOnTargetPrimitiveDestruction"))
