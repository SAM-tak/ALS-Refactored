...
{
	UE_DEFINE_GAMEPLAY_TAG(ViewMode, FName{TEXTVIEW("Als.ViewMode")})
...
{
	UE_DEFINE_GAMEPLAY_TAG(LocomotionMode, FName{TEXTVIEW("Als.LocomotionMode")})
...
{
	UE_DEFINE_GAMEPLAY_TAG(RotationMode, FName{TEXTVIEW("Als.RotationMode")})
...
{
	UE_DEFINE_GAMEPLAY_TAG(AimingMode, FName{TEXTVIEW("Als.AimingMode")})
...
{
	UE_DEFINE_GAMEPLAY_TAG(Stance, FName{TEXTVIEW("Als.Stance")})
...
{
	UE_DEFINE_GAMEPLAY_TAG(Gait, FName{TEXTVIEW("Als.Gait")})
...
{
	UE_DEFINE_GAMEPLAY_TAG(OverlayMode, FName{TEXTVIEW("Als.OverlayMode")})
...
{
	UE_DEFINE_GAMEPLAY_TAG(LocomotionAction, FName{TEXTVIEW("Als.LocomotionAction")})
...
{
	UE_DEFINE_GAMEPLAY_TAG(GroundedEntryMode, FName{TEXTVIEW("Als.GroundedEntryMode")})
